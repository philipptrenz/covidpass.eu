<template>
  <button @click="$emit('click')"
    class="cursor-pointer bg-btn text-primary hover:bg-btn-hover active:bg-btn-active text-xl font-medium rounded-lg p-3 flex flex-row justify-center align-middle ">
